...
input string         InpOutputFile   = "results\\live_crypto.csv";
input ENUM_TIMEFRAMES InpTF          = PERIOD_M5;
input int            InpTimerSeconds = 10;
input string         InpSymbols      = "BTCUSD,ETHUSD";  // Comma-separated symbols
...
int OnInit()
{
   ...
   PrintFormat("MultiSymbolExporter initialized | file=%s tf=%d symbols=%s", 
